...
case class AppUser(var id: Long, var email: String, var name: String, var surname: String, var password: String) extends User {
  override def toString =
    "User(id=" + id + ", email=" + email + ", name=" + name + ", surname=" + surname +")";
}
case class CorporateUser(var id: Long, var email: String, var name: String, var surname: String, var password: String, var companyId: Long) extends User {
  override def toString =
